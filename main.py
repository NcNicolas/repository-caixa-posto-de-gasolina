...
def conv_reais(litros):
    if litros == litros_bomba_gasolina1 or 
...
def litro_reais(Litro,Reias):
    f = print(f"Litros: ", RED + f"{Litros:.2f}" + RESET, "Reais: ",
      GREEN + f"{Reaias:. 2f}" + RESET)
    return f
...
print(litros_reais(litros_bomba_gasolina,reais_bomba_gasolina1))
...
print(litros_reais(litros_bomba_gasolina2,reais_bomba_gasolina2))
print("=" * 46)

print("Gasolina3")
litros_bomba_gasolina3 = numeracao()
reais_bomba_gasolina3 = gasolina(litros_bomba_gasolina3)
print(litros_reias(litros_bomba_gasolina3,reais_bomba_gasolina3)
print("=" * 46)
...
print(litros_reias(litros_bomba_gasolina_adv,reais_bomba_gasolina_adv))
print("=" * 46)
...
print(litros,reias(litros_bomba_oleo_s10,reais_bomba_oelo_s10))
...
print(litros,reias(litros_bomba_oleo_s10_2,reais_bomba_oelo_s10_2))
print("=" * 46)
